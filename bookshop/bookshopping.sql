...
-- order테이블의 주문번호 1번 가격을 7000원으로 변경
UPDATE orders
SET saleprice = 7000
WHERE orderid = 1;
...
SELECT  TO_CHAR(orderdate, 'YYYY-MM-DD') orderdate
FROM orders;

SELECT orderid, custid, bookid, saleprice, TO_CHAR(orderdate, 'YYYY-MM-DD') orderdate
FROM orders;
